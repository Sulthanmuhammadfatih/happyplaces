...
class DataBaseHandler(context: Context) : SQLiteOpenHelper(context,  DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    fun addHappyPlace(happyPlaceModel: HappyPlaceModel): Long {
        ...
        contextValues.put(KEY_TITLE, happyPlaceModel.title)
        contextValues.put(KEY_IMAGE,happyPlaceModel.image)
        contextValues.put(KEY_DESCRIPTION,happyPlaceModel.description)
        contextValues.put(KEY_DATE,happyPlaceModel.date)
        contextValues.put(KEY_LOCATION,happyPlaceModel.location)
        contextValues.put(KEY_LATITUDE,happyPlaceModel.latitude)
        contextValues.put(KEY_LONGITUDE,happyPlaceModel.longitude)

        val result = db.insert(TABLE_HAPPY_PLACE, null, contextValues)
        db.close()
        return result
    }
    ...
    fun updateHappyPLace (happyPlaceModel: HappyPlaceModel): Int {
        ...
        Log.e("IDUpdate", happyPlaceModel.id.toString())
        //contentValues.put(KEY_ID, happyPlaceModel.id)
